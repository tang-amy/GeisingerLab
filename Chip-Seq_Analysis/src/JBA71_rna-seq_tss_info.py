...
"""
11/20/2020 Update:
Adapt to rna-seq table for ARAC_vs_CON_+ATc_T1T2_RNAseqDGE-ResultsToLab.csv
"""
...
def read_rna_seq(csv):
    ...
    df_rna_seq = df_rna_seq[['Geneid', 'Chr', 'Start', 'End',
                             ...
                             'Gene names', 'Organism', 'Length.1', 'Gene names  (primary )', 'EC number',
                             'Gene ontology (biological process)', 'Gene ontology (cellular component)',
                             'Gene ontology (GO)', 'Gene ontology (molecular function)', 'Gene ontology IDs',
                             'Gene', 'baseMean', 'log2FC_vscon_T1', 'lfcSE', 'stat', 'pvalue', 'padj_T1',
                             'X.ExpOut.190903_NS500751_0147_AHFGCHBGXC.Out.Rep.Bams.ab17978.T1sgARACaTc.1',
                             'X.ExpOut.190903_NS500751_0147_AHFGCHBGXC.Out.Rep.Bams.ab17978.T1sgARACaTc.2',
                             'X.ExpOut.190903_NS500751_0147_AHFGCHBGXC.Out.Rep.Bams.ab17978.T1sgARACaTc.3',
                             'X.ExpOut.190903_NS500751_0147_AHFGCHBGXC.Out.Rep.Bams.ab17978.T1sgCONaTc.1',
                             'X.ExpOut.190903_NS500751_0147_AHFGCHBGXC.Out.Rep.Bams.ab17978.T1sgCONaTc.2',
                             'X.ExpOut.190903_NS500751_0147_AHFGCHBGXC.Out.Rep.Bams.ab17978.T1sgCONaTc.3',
                             'Gene.1', 'baseMean.1', 'log2FC_vscon_T2', 'lfcSE.1', 'stat.1',
                             'pvalue.1', 'padj_T2',
                             'X.ExpOut.190903_NS500751_0147_AHFGCHBGXC.Out.Rep.Bams.ab17978.T2sgARACaTc.1',
                             'X.ExpOut.190903_NS500751_0147_AHFGCHBGXC.Out.Rep.Bams.ab17978.T2sgARACaTc.2',
                             'X.ExpOut.190903_NS500751_0147_AHFGCHBGXC.Out.Rep.Bams.ab17978.T2sgARACaTc.3',
                             'X.ExpOut.190903_NS500751_0147_AHFGCHBGXC.Out.Rep.Bams.ab17978.T2sgCONaTc.1',
                             'X.ExpOut.190903_NS500751_0147_AHFGCHBGXC.Out.Rep.Bams.ab17978.T2sgCONaTc.2',
                             'X.ExpOut.190903_NS500751_0147_AHFGCHBGXC.Out.Rep.Bams.ab17978.T2sgCONaTc.3']]
    return df_rna_seq
...
def rna_seq_info(locus, df_rna_seq):
    ...
    log2FC_T1 = df_rna_seq.loc[df_rna_seq['Gene'] == locus, 'log2FC_vscon_T1'].item()
    padj_T1 = df_rna_seq.loc[df_rna_seq['Gene'] == locus, 'padj_T1'].item()
    log2FC_T2 = df_rna_seq.loc[df_rna_seq['Gene'] == locus, 'log2FC_vscon_T2'].item()
    padj_T2 = df_rna_seq.loc[df_rna_seq['Gene'] == locus, 'padj_T2'].item()
    ...
    try:
        padj_T1 = '{:.2e}'.format(float(padj_T1))
    except ValueError:
        pass
    try:
        padj_T2 = '{:.2e}'.format(float(padj_T2))
    except ValueError:
        pass
    return [log2FC_T1, padj_T1, log2FC_T2, padj_T2, Chr, Length, Protein_ID, K_Number, Global_Gene,
