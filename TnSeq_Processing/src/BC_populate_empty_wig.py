...
def populate_wig_file(wigfile,infile,outfile,isold):
    ...
    print("Number of insertions within 1 nt of a TA site: ", q1)
    print("Number of insertions within 2 nt of a TA site: ", q2)
    print("Number of insertions > 2 nt away from a TA site: ", q3, "(Discarded)")
